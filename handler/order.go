...
import (
	...
	"github.com/Jubilio/order-api/model"
	"github.com/Jubilio/order-api/repository/order"
...
func (h *Order) Create(w http.ResponseWriter, r *http.Request) {
	var body struct {
		CustumerID uuid.UUID        `json:"customer_id"`
...
func (h *Order) GetByID(w http.ResponseWriter, r *http.Request) {
	...
	if errors.Is(err, order.ErrNotExit) {
		w.WriteHeader(http.StatusNotFound)
		return
	} else if err != nil {
		fmt.Println("failed to fiind by id: ", err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	}
